...
* @dev AM contract that want to forward the message to the receiving blockchain need to call this method to send auth message.
    ...
    * @dev SDP contract are based on the AuthMessage contract. Here we set the AuthMessage contract address.
     ...
     */
    function sendMessageV2(string receiverDomain, bytes32 receiverID, address senderID, bool atomic, bytes message) external returns (bytes32);
     ...
     * @param message the raw message from DApp contracts
     */
    function sendMessage(string receiverDomain, bytes32 receiverID, address senderID, bytes message) external;
     ...
     * @return the message id of SDP packet sent.
     */
    function sendUnorderedMessageV2(string receiverDomain, bytes32 receiverID, address senderID, bool atomic, bytes message) external returns (bytes32);
     ...
     * @param message the raw message from DApp contracts
     */
    function sendUnorderedMessage(string receiverDomain, bytes32 receiverID, address senderID, bytes message) external;
