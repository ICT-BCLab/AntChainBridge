...
interface IContractWithAcks {
     ...
     */
    function ackOnSuccess(bytes32 messageId, string receiverDomain, bytes32 receiver, uint32 sequence, uint64 nonce, bytes message) external;
     ...
     */
    function ackOnError(bytes32 messageId, string receiverDomain, bytes32 receiver, uint32 sequence, uint64 nonce, bytes message, string errorMsg) external;
}
