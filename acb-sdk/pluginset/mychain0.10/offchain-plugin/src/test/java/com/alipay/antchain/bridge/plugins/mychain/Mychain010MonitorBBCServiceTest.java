...
import com.alipay.antchain.bridge.plugins.mychain.contract.MonitorContractClientEVM;
import com.alipay.antchain.bridge.plugins.mychain.contract.MonitorVerifierContractEVM;
import com.alipay.antchain.bridge.plugins.mychain.contract.PtcContractEvm;
import com.alipay.antchain.bridge.plugins.mychain.contract.SDPContractClientEVM;
...
public class Mychain010MonitorBBCServiceTest {
    ...
    private Mychain010BBCService service;
    ...
    @Before
    public void setUp() {
        service = new Mychain010BBCService();
        context = new Mychain010BBCContext(new DefaultBBCContext(), LoggerFactory.getLogger(getClass()));
        ...
        when(mychain010Client.getPrimary()).thenReturn("mychain-monitor-test");
        when(mychain010Client.isTeeChain()).thenReturn(false);
        ...
        ReflectUtil.setFieldValue(service, "mychain010Client", mychain010Client);
    }
    ...
    public void setProtocolShouldAutomaticallyUpgradeLegacyMonitor() {
        ...
        Mychain010BBCService serviceSpy = spy(service);
    ...
    public void setupMonitorContractShouldRejectTeeChain() {
        when(mychain010Client.isTeeChain()).thenReturn(true);
