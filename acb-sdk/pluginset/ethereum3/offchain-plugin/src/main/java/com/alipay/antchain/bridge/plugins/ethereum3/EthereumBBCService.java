...
import com.alipay.antchain.bridge.plugins.ethereum3.core.AcbEthClient;
...
import static com.alipay.antchain.bridge.plugins.ethereum3.abi.AuthMsg.SENDAUTHMESSAGE_EVENT;

@BBCService(products = "ethereum3", pluginId = "plugin-ethereum3")
@Getter
